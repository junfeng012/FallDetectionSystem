...
public class EditPasswordFinish extends AppCompatActivity  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_edit_password_finish);
        ...
        homeButton_Image=(ImageButton) findViewById(R.id.epf_HomeButton_Image);

        homeButton_Image.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(EditPasswordFinish.this,Home.class);
