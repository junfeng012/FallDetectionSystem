...
public class AddCaretakerFinish extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_caretaker_finish);
        ...
        homeButton_Image=(ImageButton) findViewById(R.id.acf_HomeButton_Image);

        homeButton_Image.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(AddCaretakerFinish.this,Home.class);
