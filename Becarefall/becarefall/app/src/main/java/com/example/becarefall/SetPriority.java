...
public class SetPriority extends AppCompatActivity  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        set_Button =(Button)findViewById(R.id.sp_Set_Button);
        homeButton_Image=(ImageButton) findViewById(R.id.sp_HomeButton_Image);

        homeButton_Image.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(SetPriority.this,Home.class);
        ...
        set_Button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                else if(chosenRadioID!=-1)
                {
                    ...
                    Intent intent = new Intent(SetPriority.this,SetPriorityFinish.class);
                    intent.putExtra("userAccount",user_Account);
                    intent.putExtra("userUser",user_User);
                    intent.putExtra("cCaretakerArray",c_CaretakerArray);
                    intent.putExtra("userCaretakerArray", user_CaretakerArray);
    ...
    public void addRadioButtons() {
        ...
        caretakerList_RadioGroup=(RadioGroup) findViewById(R.id.sp_CaretakerList_RadioGroup);
    ...
    public void find_cCaretakerArrayIndex()
    {
        ...
        String caretakerID = user_Caretaker.getCaretakerID();

        for(int i = 0 ; i< c_CaretakerArray.size() ; i++)
        {
            String temp_caretakerID= c_CaretakerArray.get(i).getCaretakerID();
            if(caretakerID.equals(temp_caretakerID))
            {
